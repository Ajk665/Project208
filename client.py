...
def openChatWindow():
    ...
    atButton=Button(window,text="Attach & Send",bd=1, font = ("Calibri",10))
    atButton.place(x=10,y=305)
    ...
    filePathLabel1 = Label(window, text= "", fg = "blue", font = ("Calibri",10))
    filePathLabel1.place(x=10, y=330)
